...
def _create_engineering_material(model, name, props, orientation):
    if name in model.materials.keys(): return
    model.Material(name=name)
    nu21 = props['nu12'] * (props['E22'] / props['E11'])

    if orientation == '0deg':
        table = ((props['E11'], props['E22'], props['E22'], props['nu12'], props['nu12'], props['nu23'], props['G12'], props['G12'], props['G23']),)
    elif orientation == '90deg':
        table = ((props['E22'], props['E22'], props['E11'], props['nu23'], nu21, nu21, props['G23'], props['G12'], props['G12']),)
...
def build_model(L=70.0, t_0=0.25, t_90=0.5, rho_sat=8.0, seed=42, vf_decimals=1, model_name=MODEL_NAME):
    ...
    # خطوط عمودی ساده به عنوان مرز مسیرهای ترک (بدون ترفند 1e-4)
